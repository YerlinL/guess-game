export default {
  ...
  pistas: {
    ...
    "post office":
      "This place is in charge of collecting and sending your letters.",
  ...
  imagenes: {
    baker: "./img/Community_Helpers/Baker.png",
    butcher: "./img/Community_Helpers/Butcher.png",
    salesman: "./img/Community_Helpers/Salesman.png",
    saleswoman: "./img/Community_Helpers/Saleswoman.png",
    cashier: "./img/Community_Helpers/Cashier.png",
    hairdresser: "./img/Community_Helpers/Hairdresser.png",
    mechanic: "./img/Community_Helpers/Mechanic.png",
    chef: "./img/Community_Helpers/Chef.png",
    farmer: "./img/Community_Helpers/Farmer.png",
    waiter: "./img/Community_Helpers/Waiter.png",
    waitress: "./img/Community_Helpers/Waitress.png",
